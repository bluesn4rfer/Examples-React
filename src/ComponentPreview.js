...
import { Container, Row, Col, Form, Button, Dropdown, DropdownButton, Navbar, Nav, NavDropdown } from 'react-bootstrap';
...
function ComponentPreview() {
	const componentMap = {
		...
		moment,
		Container, Row, Col, Form, Button, Dropdown, DropdownButton, Navbar, Nav, NavDropdown, // bootstrap
